...
export function VehiclePositionHistoryMap({
  positions,
  isLoading = false,
}: VehiclePositionHistoryMapProps) {
  if (isLoading) {
    return (
      <div
        className="h-96 w-full rounded-2xl bg-slate-100 animate-pulse"
        data-testid="position-history-skeleton"
      />
    );
  }
  ...
  return (
    <div>
      <div
        className="h-96 w-full rounded-2xl overflow-hidden border border-slate-200"
        data-testid="position-history-map"
      >
        <MapContainer
      ...
      <div
        ...
        data-testid="position-history-legend"
      >
