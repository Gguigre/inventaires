...
export function CorrectionModal({ isOpen, itemName, currentExpiryDate, dateValue, dateError, isSubmitting, error, onDateChange, onConfirm, onClose }: CorrectionModalProps) {
  if (!isOpen) return null

  return (
    <div role="dialog" aria-modal="true" aria-labelledby="correction-modal-title"
      ...
      <div className="relative bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm mx-4 space-y-4">
        ...
        <div>
          <h2 id="correction-modal-title" className="text-base font-bold text-slate-900">Corriger la péremption</h2>
        ...
        <div>
          <label htmlFor="input-new-expiry-date" className="block text-sm font-medium text-slate-700 mb-1.5">
            Nouvelle date de péremption <span className="text-red-500">*</span>
          </label>
          <input
            id="input-new-expiry-date"
        ...
        <div className="flex gap-2 justify-end pt-1">
          ...
          <button type="button" data-testid="btn-confirm-correction" onClick={onConfirm} disabled={isSubmitting}
